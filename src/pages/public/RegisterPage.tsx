  ...
  return (
    <AuthLayout>
      <div className="flex flex-col items-center w-full max-w-md mx-auto p-6 md:p-8 bg-cream-card rounded-card shadow-card relative z-10">
        <h1 className="font-playfair text-title text-charcoal font-semibold mb-2 text-center">Create Your Account</h1>
        <p className="text-body-md text-charcoal-light mb-8 text-center">Begin your Ayurvedic skin journey</p>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="w-full space-y-4">
          <div className="space-y-1">
            ...
            />
            {errors.fullName && <p className="text-turmeric text-caption pl-1">{errors.fullName.message}</p>}
          </div>
          ...
          <div className="space-y-1 relative">
            ...
            {errors.confirmPassword && <p className="text-turmeric text-caption pl-1">{errors.confirmPassword.message}</p>}
          </div>
          ...
          <motion.button
            ...
            disabled={isLoading}
            type="submit"
            className="w-full bg-herbal text-white rounded-button py-3 font-medium text-body-md mt-2 flex justify-center items-center gap-2 hover:bg-opacity-90 transition-all disabled:opacity-70 shadow-sm"
          >
        ...
        <p className="mt-8 text-small text-charcoal-light">
          ...
          <Link to="/login" className="text-herbal font-medium hover:underline">
            Sign In
          </Link>
        </p>
      </div>
